  ...
  return (
    <FloatingPortal>
      <div
        ...
        {...getFloatingProps()}
        className="z-50 w-80 bg-white dark:bg-gray-900 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 flex flex-col animate-in fade-in zoom-in-95 duration-150"
      >
        {/* 头部：单词与读音 */}
